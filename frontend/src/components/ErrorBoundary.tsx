        ...
        <div className="min-h-screen bg-gray-50 flex items-center justify-center p-4">
          <div className="bg-white rounded-2xl border border-red-200 p-8 max-w-md w-full text-center">
            ...
            <p className="text-sm text-gray-600 mb-6">
              There was an error loading the wallet connection. This might be
              due to browser extension compatibility issues.
            </p>
            <button
            ...
            <p className="text-xs text-gray-500 mt-4">
              Make sure you have Leather Wallet extension installed and try
              refreshing the page.
            </p>
          </div>
        </div>
